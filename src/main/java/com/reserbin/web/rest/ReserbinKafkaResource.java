...
import com.reserbin.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/reserbin-kafka")
public class ReserbinKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ReserbinKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public ReserbinKafkaResource(KafkaProperties kafkaProperties) {
